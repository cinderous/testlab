...
public class PacketUtil {
	  ...
	  public static TileEntity handleTileEntityPacket(World world, boolean readId, DataInputStream dis) {
	    ...
	    if(world == null) {
	    	System.out.println("PacketUtil.handleTileEntityPacket: Null world recieved when processing tile entity packet.");
	      return null;
	    }
	    TileEntity te = world.getBlockTileEntity(x, y, z);
	    if(te == null) {
	      System.out.println("PacketUtil.handleTileEntityPacket: TileEntity null when processing tile entity packet.");
	      return null;
	    }
	    te.readFromNBT(tags);
	    return te;
